    ...
    return (
        <footer className="bg-navy text-white pt-24 pb-12 rounded-t-[4rem] relative overflow-hidden group">
            ...
            <div className="absolute inset-0 z-0">
                <img src="/business_reality_quote_bg.png" alt="" className="w-full h-full object-cover opacity-20 grayscale group-hover:grayscale-0 group-hover:opacity-30 group-hover:scale-105 transition-all duration-1000" />
