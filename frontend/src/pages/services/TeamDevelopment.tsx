            ...
            <section className="bg-navy pt-40 pb-32 relative overflow-hidden text-white">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-6 tracking-tighter leading-tight">
                        Build Aligned, <br /><span className="font-serif italic text-teal">High-Performing Teams</span>
                    </h1>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto bg-beige/10 border-l-4 border-teal p-8 md:p-12 rounded-r-[2rem] shadow-sm">
                        ...
                        <p className="text-xl md:text-2xl text-navy font-bold leading-relaxed italic">
                            "What is Team Development? It is the strategic alignment of individual capabilities and interpersonal trust to create an ecosystem of performance, synergy, and shared accountability."
                        </p>
                    </div>
                </div>
            </section>
