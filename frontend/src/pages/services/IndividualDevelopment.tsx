            ...
            <section className="py-24 bg-beige/30">
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="bg-white p-8 md:p-16 rounded-[3rem] md:rounded-[4rem] shadow-2xl border border-navy/5 relative overflow-hidden mb-20">
                        ...
                        <h2 className="text-2xl md:text-5xl font-black text-navy mb-8 tracking-tighter">Individual potential is <span className="text-teal font-serif italic">not a static asset.</span></h2>
