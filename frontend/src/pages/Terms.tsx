        ...
        <div className="bg-navy min-h-screen pt-32 pb-24 text-white/80">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                >
                    <Link
                        to="/"
                        className="flex items-center space-x-2 text-teal/60 hover:text-white transition-colors font-mono text-[10px] font-bold uppercase tracking-widest group"
                    >
                ...
                <header className="mb-20">
                    ...
                    <motion.p
                        ...
                        className="text-white/40 font-mono font-bold text-xs tracking-[0.3em] uppercase"
                    >
                ...
                <div className="space-y-16">
                    ...
                    >
                        ...
                        <p className="text-white/60 text-lg leading-relaxed font-light">
                            By accessing the website at <a href="https://www.metahr.co.in" className="text-white font-bold hover:text-teal underline underline-offset-4 decoration-teal/40">www.metahr.co.in</a> or engaging in our consulting services, you agree to be bound by these Terms and Conditions and all applicable laws and regulations. MetaHR provides strategic HR consulting, leadership development, and team coaching services designed to maximize organizational potential.
                        </p>
                    </motion.section>
                    ...
                    >
                        ...
                        <div className="space-y-8">
                            <div>
                                <h4 className="font-black text-white text-sm uppercase tracking-widest mb-3">Strength-Based Leadership Development</h4>
                                <p className="text-white/60 text-lg leading-relaxed font-light">Leveraging frameworks such as The Leadership Challenge® and Gallup CliftonStrengths.</p>
                            </div>
                            <div>
                                <h4 className="font-black text-white text-sm uppercase tracking-widest mb-3">Cohesive Team Development</h4>
                                <p className="text-white/60 text-lg leading-relaxed font-light">Utilizing The Five Behaviors® of a Cohesive Team and Everything DiSC®.</p>
                            </div>
                            <div>
                                <h4 className="font-black text-white text-sm uppercase tracking-widest mb-3">HR Strategy & Organizational Effectiveness</h4>
                                <p className="text-white/60 text-lg leading-relaxed font-light">Including talent acquisition strategy, performance management, and HR process optimization.</p>
                            </div>
                        </div>
                    </motion.section>
                    ...
                    >
                        ...
                        <p className="text-white/60 text-lg leading-relaxed font-light italic border-l-4 border-teal/40 pl-8 ml-2">
                    ...
                    <motion.section
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="bg-white/5 border border-white/10 p-12 rounded-[3rem] text-white"
                    >
                        ...
                        <div className="grid md:grid-cols-2 gap-10">
                            <div className="space-y-6">
                                ...
                                >
                                    ...
                                    <span className="font-bold text-sm tracking-widest uppercase text-white/80 group-hover:text-white transition-colors">info@metahr.co.in</span>
                                </a>
                                <a
                                ...
                                >
                                    ...
                                    <span className="font-bold text-sm tracking-widest uppercase text-white/80 group-hover:text-white transition-colors">+91 91876 51277</span>
                                </a>
                            </div>
                ...
                <motion.div
                    ...
                    className="mt-32 pt-16 border-t border-white/5 flex flex-col items-center"
                >
                    <div className="flex items-center space-x-3 px-6 py-3 rounded-full border border-white/10 bg-white/5">
                        <span className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
                        </span>
                        <span className="text-[10px] font-mono font-bold tracking-[0.4em] text-white/40 uppercase">System_Status // Operational</span>
                    </div>
                </motion.div>
            </div>
        </div>
